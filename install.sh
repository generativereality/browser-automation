...
echo "  mkdir -p .claude/skills/browser/references"
echo "  base=https://raw.githubusercontent.com/generativereality/browser-automation/master/skills/browser"
echo "  for f in SKILL.md references/input-and-forms.md references/renderer-health.md references/contributing.md; do"
echo "    curl -fsSL \"\$base/\$f\" -o \".claude/skills/browser/\$f\""
echo "  done"
